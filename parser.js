    ...
    newInstance: function() {
        var obj = {
			...
			bindEvent: function() {
                ...
                $(document).on('click', 'span.phonetic-char', function(e) {
                    console.log(this);
                    var searchUrl="http://zdic.net/search/?q="+this.innerHTML+"&c=2"
                    window.open(searchUrl,'jdjm','height=500, width=386, top=100, left='+(((window.screen.width)?(window.screen.width):800)*2/3)+', toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no',true);
